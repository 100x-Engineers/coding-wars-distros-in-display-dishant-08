  ...
  const fetchData = async () => {
    ...
    try {
      response = await fetch(
        `http://localhost:3000/complete-text?input=${finalPrompt}`
      );
...
function generatePrompt() {
  ...
  let prompt = `Create a personalized portfolio with the following details and structure it in a div tag:\n`;
